/* wickra-benchmark C ABI — generated by cbindgen; do not edit by hand. */

#ifndef WICKRA_BENCHMARK_H
#define WICKRA_BENCHMARK_H
...
#define WICKRA_BENCHMARK_ERR_NULL -1

// `cmd_json` was not valid UTF-8.
#define WICKRA_BENCHMARK_ERR_UTF8 -2

// A panic was caught at the FFI boundary.
#define WICKRA_BENCHMARK_ERR_PANIC -3

// An opaque handle to a benchmark instance. Created by [`wickra_benchmark_new`]
// and destroyed by [`wickra_benchmark_free`]; never dereferenced by the caller.
typedef struct WickraBenchmark WickraBenchmark;
...
//
// Never fails; free the handle with [`wickra_benchmark_free`].
WickraBenchmark *wickra_benchmark_new(void);

// Destroy a benchmark handle. Null is a no-op.
//
// # Safety
// `handle` must be null or a handle previously returned by
// [`wickra_benchmark_new`] and not already freed.
